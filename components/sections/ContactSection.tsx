...
export default function ContactSection() {
  ...
  return (
    <section id="get-in-touch" className="px-6 pt-6 pb-16 md:pt-8 md:pb-20 lg:pt-10 lg:pb-24">
      <div className="mx-auto max-w-7xl">
        <div className="section-label mb-6 md:mb-8">Get In Touch</div>
        <h2 className="font-hero-serif mb-6 text-4xl font-normal leading-[0.95] tracking-[-0.02em] text-balance text-[#E0DDD8] md:text-5xl lg:text-6xl">
          30 minutes. No pitch.
          <br />
          Just a conversation.
        </h2>
