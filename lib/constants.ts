...
export const WORK_CATEGORIES: WorkCategory[] = [
  {
    ...
    tagline: "Where brand, product and positioning meet.",
    brands: [
      {
        id: 1,
        client: "Dis-Chem",
      ...
      },
      {
        id: 3,
        client: "Freethinking",
        outcome: "New brand system for an independent creative studio.",
        placeholder: "FT",
      },
    ],
  },
  {
    id: "logo-design",
    name: "Logo Design",
    tagline: "Marks built to hold up under real pressure.",
    brands: [
      {
        id: 1,
        client: "X,bigly",
      ...
      {
        id: 2,
        client: "Funding Frontier",
        outcome: "Mark and identity for an early-stage fintech platform.",
        placeholder: "FF",
      },
      {
        id: 3,
        client: "Chicken Licken",
        outcome: "Evolved a legacy quick-service mark for modern retail.",
        placeholder: "CL",
      },
    ],
  },
  {
    id: "ui-ux",
    name: "UI/UX Design",
    tagline: "Interfaces built to hold up under real product pressure.",
    brands: [
      {
        id: 1,
        client: "Yoco",
      ...
      },
      {
        id: 3,
        client: "SuperSport",
        outcome: "Redesigned the broadcast-to-digital viewing experience.",
        placeholder: "SS",
      },
    ],
  },
  {
    ...
    tagline: "Go-to-market that actually moves the number.",
    brands: [
      {
        id: 1,
        client: "GLTV",
        outcome: "120,000 viewers at launch through zero paid media.",
        placeholder: "GL",
      },
      {
        id: 2,
        client: "Discovery",
        outcome: "Leadership Summit programme at global enterprise scale.",
        placeholder: "DI",
      },
      {
        id: 3,
        client: "Liverpool FC",
        outcome: "Brand activation for a club with 400 million fans.",
        placeholder: "LF",
      },
    ],
  },
