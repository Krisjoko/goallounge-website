...
export const PROJECTS = [
  ...
  { id: 20, name: "Aerium", category: "Logo Design", discipline: "Logo Design" as Discipline, outcome: "Logo mark for Aerium.", description: "Identity mark for Aerium.", images: ["/Aerium-1.png"], placeholder: "AE" },
  { id: 21, name: "Claudio Barreiro", category: "Logo Design", discipline: "Logo Design" as Discipline, outcome: "Personal brand mark.", description: "Identity mark for Claudio Barreiro.", images: ["/CB-1.png"], placeholder: "CB" },
  { id: 22, name: "EMH (Eden Machined Hydraulics)", category: "Logo Design", discipline: "Logo Design" as Discipline, outcome: "Industrial brand mark.", description: "Identity mark for Eden Machined Hydraulics.", images: ["/EMH-1.png", "/EMH-2.png"], placeholder: "EMH" },
  { id: 23, name: "F2 (Formula 2)", category: "Logo Design", discipline: "Logo Design" as Discipline, outcome: "Motorsport brand mark.", description: "Identity mark for Formula 2.", images: ["/F2-1.png"], placeholder: "F2" },
  { id: 24, name: "Funding Frontier (opt1)", category: "Logo Design", discipline: "Logo Design" as Discipline, outcome: "Fintech brand mark — option 1.", description: "Logo concept 1 for Funding Frontier.", images: ["/FF-1.png"], placeholder: "FF1" },
  { id: 25, name: "Funding Frontier (opt2)", category: "Logo Design", discipline: "Logo Design" as Discipline, outcome: "Fintech brand mark — option 2.", description: "Logo concept 2 for Funding Frontier.", images: ["/FF-2.png"], placeholder: "FF2" },
  { id: 26, name: "Funding Frontier (opt3)", category: "Logo Design", discipline: "Logo Design" as Discipline, outcome: "Fintech brand mark — option 3.", description: "Logo concept 3 for Funding Frontier.", images: ["/FF-3.png"], placeholder: "FF3" },
  { id: 27, name: "Funding Frontier (opt4)", category: "Logo Design", discipline: "Logo Design" as Discipline, outcome: "Fintech brand mark — option 4.", description: "Logo concept 4 for Funding Frontier.", images: ["/FF-4.png"], placeholder: "FF4" },
  { id: 28, name: "Goallounge", category: "Logo Design", discipline: "Logo Design" as Discipline, outcome: "Platform brand mark.", description: "Identity mark for Goallounge.", images: ["/GLTV-1.png"], placeholder: "GL" },
  { id: 29, name: "Hybrid Risk", category: "Logo Design", discipline: "Logo Design" as Discipline, outcome: "Risk consultancy brand mark.", description: "Identity mark for Hybrid Risk.", images: ["/HybridRisk-1.png"], placeholder: "HR" },
  { id: 30, name: "Novo FX (opt1)", category: "Logo Design", discipline: "Logo Design" as Discipline, outcome: "FX brand mark — option 1.", description: "Logo concept 1 for Novo FX.", images: ["/NovoFX-1.png"], placeholder: "NX1" },
  { id: 31, name: "Novo FX (opt2)", category: "Logo Design", discipline: "Logo Design" as Discipline, outcome: "FX brand mark — option 2.", description: "Logo concept 2 for Novo FX.", images: ["/NovoFX-2.png"], placeholder: "NX2" },
  { id: 32, name: "Novo FX (opt3)", category: "Logo Design", discipline: "Logo Design" as Discipline, outcome: "FX brand mark — option 3.", description: "Logo concept 3 for Novo FX.", images: ["/NovoFX-3.png"], placeholder: "NX3" },
  { id: 33, name: "Oh So Niche (opt1)", category: "Logo Design", discipline: "Logo Design" as Discipline, outcome: "Lifestyle brand mark — option 1.", description: "Logo concept 1 for Oh So Niche.", images: ["/OhSoNiche-1.png"], placeholder: "OS1" },
  { id: 34, name: "Oh So Niche (opt2)", category: "Logo Design", discipline: "Logo Design" as Discipline, outcome: "Lifestyle brand mark — option 2.", description: "Logo concept 2 for Oh So Niche.", images: ["/OhSoNiche-2.png"], placeholder: "OS2" },
  { id: 35, name: "Source (opt1)", category: "Logo Design", discipline: "Logo Design" as Discipline, outcome: "Brand mark — option 1.", description: "Logo concept 1 for Source.", images: ["/Source-1.png"], placeholder: "SO1" },
  { id: 36, name: "Source (opt2)", category: "Logo Design", discipline: "Logo Design" as Discipline, outcome: "Brand mark — option 2.", description: "Logo concept 2 for Source.", images: ["/Source-2.png"], placeholder: "SO2" },
  { id: 37, name: "SpotOn (opt1)", category: "Logo Design", discipline: "Logo Design" as Discipline, outcome: "Brand mark — option 1.", description: "Logo concept 1 for SpotOn.", images: ["/SpotOn-1.png"], placeholder: "SP1" },
  { id: 38, name: "SpotOn (opt2)", category: "Logo Design", discipline: "Logo Design" as Discipline, outcome: "Brand mark — option 2.", description: "Logo concept 2 for SpotOn.", images: ["/SpotOn-2.png"], placeholder: "SP2" },
  { id: 39, name: "SpotOn (opt3)", category: "Logo Design", discipline: "Logo Design" as Discipline, outcome: "Brand mark — option 3.", description: "Logo concept 3 for SpotOn.", images: ["/SpotOn-3.png"], placeholder: "SP3" },
  { id: 40, name: "SpotOn (opt4)", category: "Logo Design", discipline: "Logo Design" as Discipline, outcome: "Brand mark — option 4.", description: "Logo concept 4 for SpotOn.", images: ["/SpotOn-4.png"], placeholder: "SP4" },
  { id: 41, name: "Superfluid", category: "Logo Design", discipline: "Logo Design" as Discipline, outcome: "Tech brand mark.", description: "Identity mark for Superfluid.", images: ["/Superfluid-1.png"], placeholder: "SF" },
  { id: 42, name: "TEN4 (opt1)", category: "Logo Design", discipline: "Logo Design" as Discipline, outcome: "Brand mark — option 1.", description: "Logo concept 1 for TEN4.", images: ["/TEN4-1.png"], placeholder: "T41" },
  { id: 43, name: "TEN4 (opt2)", category: "Logo Design", discipline: "Logo Design" as Discipline, outcome: "Brand mark — option 2.", description: "Logo concept 2 for TEN4.", images: ["/TEN4-2.png"], placeholder: "T42" },
  { id: 44, name: "TEN4 (opt3)", category: "Logo Design", discipline: "Logo Design" as Discipline, outcome: "Brand mark — option 3.", description: "Logo concept 3 for TEN4.", images: ["/TEN4-3.png"], placeholder: "T43" },
  { id: 45, name: "Winning Edge", category: "Logo Design", discipline: "Logo Design" as Discipline, outcome: "Sports brand mark.", description: "Identity mark for Winning Edge.", images: ["/WinningEdge-1.png"], placeholder: "WE" },
  { id: 46, name: "XRC", category: "Logo Design", discipline: "Logo Design" as Discipline, outcome: "Brand mark.", description: "Identity mark for XRC.", images: ["/XRC-1.png"], placeholder: "XR" },
  { id: 47, name: "YadaSllim (opt1)", category: "Logo Design", discipline: "Logo Design" as Discipline, outcome: "Brand mark — option 1.", description: "Logo concept 1 for YadaSllim.", images: ["/YadaSllim-1.png"], placeholder: "YS1" },
  { id: 48, name: "YadaSllim (opt2)", category: "Logo Design", discipline: "Logo Design" as Discipline, outcome: "Brand mark — option 2.", description: "Logo concept 2 for YadaSllim.", images: ["/YadaSllim-2.png"], placeholder: "YS2" },
  { id: 49, name: "YadaSllim (opt3)", category: "Logo Design", discipline: "Logo Design" as Discipline, outcome: "Brand mark — option 3.", description: "Logo concept 3 for YadaSllim.", images: ["/YadaSllim-3.png"], placeholder: "YS3" },
  { id: 50, name: "Yvonee", category: "Logo Design", discipline: "Logo Design" as Discipline, outcome: "Brand mark.", description: "Identity mark for Yvonee.", images: ["/Yvonee-1.png"], placeholder: "YV" },
  {
    id: 3,
    name: "Value Prop",
